...
var server = http.createServer(function (request, response){
    ...
    else if(request.url === '/images/hairless.jpg'){
    // notice we won't include the utf8 encoding
    fs.readFile('./images/hairless.jpg', function(errors, contents){
        response.writeHead(200, {'Content-type': 'image/jpg'});
        response.write(contents);
        response.end();
    })
  }
    else if(request.url === '/images/ugly.jpg'){
    // notice we won't include the utf8 encoding
    fs.readFile('./images/ugly.jpg', function(errors, contents){
        response.writeHead(200, {'Content-type': 'image/jpg'});
        response.write(contents);
        response.end();
    })
